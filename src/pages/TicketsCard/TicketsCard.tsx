  ...
  return (
    <div className='ticket-card-container'>
      ...
      <div className='ticket-card-content'>
        <img src="/src/assets/images/ticket-sample.png" alt="" className='ticket-card-pic' />
      ...
      <div className='ticket-card-btns'>
        <div className='distribution'>
          ...
          <img src="/src/assets/images/white-arrow-right-icon.svg" alt="" className='arrow' />
        </div>
      ...
      <details className="ticket-card-details">
        <summary>
          ...
          <svg className="icon minus" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <line x1="5" y1="12" x2="19" y2="12"></line>
          </svg>
        </summary>
